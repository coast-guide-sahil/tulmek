...
/**
 * Rich text note editor powered by Tiptap v3.
 *
 * Features: bold, italic, underline, strikethrough, highlight,
 * headings, bullet/ordered/task lists, code blocks with syntax
 * highlighting, blockquotes, links, horizontal rules.
 *
 * Stores as HTML internally, exports as markdown-like text.
 * Auto-saves to NoteStore (IndexedDB) via useProgressActions.
 */
...
/** The actual Tiptap editor — only mounted when editing */
function ActiveEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "tiptap-editor prose prose-sm sm:prose max-w-none dark:prose-invert focus:outline-none min-h-[120px] px-4 py-3",
      },
    },
    onUpdate: ({ editor: e }) => {
      if (saveTimeoutRef.current) clearTimeout(saveTimeoutRef.current);
      saveTimeoutRef.current = setTimeout(() => {
        saveNote(slug, e.getHTML());
      }, 1000);
    },
  });
      ...
      <div className="flex items-center justify-between border-t border-border px-3 py-1.5">
        ...
        <div className="flex items-center gap-2">
          <NoteActions
            ...
            getMarkdown={() => {
              try {
                // Use Tiptap's native markdown serializer (via @tiptap/markdown)
  ...
  return (
    <div className="flex flex-wrap items-center gap-0.5 border-b border-border px-2 py-1.5">
      ...
      <ToolbarButton
        ...
        label="Bold (Ctrl+B)"
      >
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M8 11h4.5a2.5 2.5 0 0 0 0-5H8v5Zm0 2v5h5a2.5 2.5 0 0 0 0-5H8ZM6 4h6.5a4.5 4.5 0 0 1 3.256 7.606A4.5 4.5 0 0 1 13 20H6V4Z"/></svg>
      </ToolbarButton>
      <ToolbarButton
        ...
        label="Italic (Ctrl+I)"
      >
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M15 20H7v-2h2.927l2.116-12H10V4h8v2h-2.927l-2.116 12H15v2Z"/></svg>
      </ToolbarButton>
      <ToolbarButton
      ...
      >
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M8 3v9a4 4 0 0 0 8 0V3h2v9a6 6 0 0 1-12 0V3h2ZM4 20h16v2H4v-2Z"/></svg>
      </ToolbarButton>
      <ToolbarButton
      ...
      <ToolbarButton
        ...
        label="Highlight"
      >
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="m15.243 4.515-6.738 6.737-.707 2.121-1.04 1.041 2.828 2.829 1.04-1.041 2.122-.707 6.737-6.738-4.242-4.242Zm6.364 3.535a1 1 0 0 1 0 1.414l-7.778 7.778-2.122.707L9.586 20.07l-5.657-5.657 2.122-2.121.707-2.122 7.778-7.778a1 1 0 0 1 1.414 0l5.657 5.657ZM4.929 19.071l1.414-1.414 1.414 1.414-1.414 1.414-1.414-1.414Z"/></svg>
      </ToolbarButton>
      ...
      <ToolbarButton
        ...
        label="Numbered list"
      >
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M8 4h13v2H8V4ZM5 3v3h1v1H3V6h1V4H3V3h2Zm-2 7h3.002v1H4v1h2v3H3v-1h2v-1H3v-3Zm2 11H3v-1h2v-1H3v-1h3v4H3v-1h2v-1ZM8 11h13v2H8v-2Zm0 7h13v2H8v-2Z"/></svg>
      </ToolbarButton>
      <ToolbarButton
      ...
      <ToolbarButton
        ...
        label="Code block"
      >
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Zm1 2v14h16V5H4Zm16 7-3.536 3.536-1.414-1.414L17.172 12l-2.122-2.122 1.414-1.414L20 12ZM6.828 12l2.122 2.122-1.414 1.414L4 12l3.536-3.536 1.414 1.414L6.828 12Zm4.416 5H9.116l3.64-10h2.128l-3.64 10Z"/></svg>
      </ToolbarButton>
      <ToolbarButton
      ...
      >
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M2 11h2v2H2v-2Zm4 0h12v2H6v-2Zm14 0h2v2h-2v-2Z"/></svg>
      </ToolbarButton>
      <ToolbarButton
...
/** Copy/Download actions for notes */
  ...
  return (
    <div className="flex items-center gap-1">
      <button
        ...
        className="inline-flex items-center gap-1 rounded px-2 py-1 text-[11px] font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
 ...
 * Simple converter for common elements — handles the output
 * Tiptap generates without needing a heavy library.
 */
    ...
    switch (el.tagName.toLowerCase()) {
      ...
      case "li": {
        ...
        if (checkbox) {
          ...
          return `- [${checked ? "x" : " "}] ${children.replace(/^\s+/, "").trim()}\n`;
        }
