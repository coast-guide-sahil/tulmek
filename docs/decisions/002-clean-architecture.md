...
- `@interview-prep/core` — zero-dependency package with domain entities, port interfaces, and use cases
...
- Mobile app imports `@interview-prep/core` and provides its own adapters
